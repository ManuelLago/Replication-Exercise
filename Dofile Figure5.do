...
pause on
capture log close
log using "logfigure5", replace text	

*save a file to hold the coefficients for stata graphs
set obs 33
gen time = _n - 8
save "amrchcesresults4", replace emptyok
...
*This dropping means we are excluding New York,Chicago and Los Angeles
...
char exp1[omit] -1
xi i.exp1, pref(_T)
*Our last year employed is 1988
