...
pause on
capture log close
log using "outputlogtableD1", replace text	


use "C:\Users\manue\OneDrive\Escritorio\Econometrics II UCD\Replication\Datasets\aer_data.dta" if chc_year_exp<=1974, clear
*Drop NY/LA/Chicago
...
local p2 = r(p)
outreg2 using "tableD1.xls", replace noparen noaster adds(Test1, `p1', Test2, `p2') title(`e(depvar)') ctitle("Weighted LPM")
...
test _60pctrurf _60pct04years _60pctmt64years _60pctnonwhit _60pctmt12schl _60pctlt4schl _pct59inclt3k _pct59incmt10k amr damr
local p2 = r(p)
outreg2 using "tableD1.xls", append noparen noaster adds(Test1, `p1', Test2, `p2') title(`e(depvar)') ctitle("Unweighted LPM")
