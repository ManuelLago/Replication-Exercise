...
pause on
capture log close
log using "outputlogtable22", replace text	

use "C:\Users\manue\OneDrive\Escritorio\Econometrics II UCD\Replication\Datasets\aer_data.dta" if year<=1988, clear
*Drop NY/LA/Chicago
...
foreach i of numlist 1 2 3 4{		
	...
	*OUTREG RESULTS
	outreg2 using "outputtable22.xls", `r' keep(_DDdid1_2 _DDdid1_4 _DDdid1_5 _DDdid1_6) noparen noaster ctitle("AMR: `e(cmdline)'") 
	local r append
}
...
foreach i of numlist 1 2 3 4{		
	...
	*OUTREG RESULTS
	outreg2 using "outputtable22.xls", `r' keep(_DDdid1_2 _DDdid1_4 _DDdid1_5 _DDdid1_6) noparen noaster ctitle("AMR 50+: `e(cmdline)'") 
	local r append
}
